...
st.markdown("Welcome to the Crop Prediction Page. This model helps you to predict the best crop to grow based on various environmental parameters. Simply enter the input parameters, and we will provide you with a crop recommendation.")
